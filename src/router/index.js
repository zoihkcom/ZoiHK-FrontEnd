...
const routes = [
  ...
  {
    path: "/cross-border-bus",
    name: "CrossBorderBus",
    component: () => import("../views/CrossBorderBus.vue"),
  },
  {
    path: "/cross-border-charter",
    name: "CrossBorderCharter",
    component: () => import("../views/CrossBorderCharter.vue"),
  },
  {
    path: "/bus",
    name: "Bus",
