        ...
        <div v-else>
          ...
          <div class="mb-6">
            ...
            <div class="mb-4 relative">
              ...
              <div v-if="selectedLocation" class="mt-2 p-2 bg-blue-50 rounded-lg">
                <div class="text-sm text-blue-700">
                  ...
                  正在显示 <span class="font-medium">{{ locationSearchQuery }}</span> 周围 2 公里内的 {{ nearbyMeteredSpaces.length
                  }} 个咪錶停车位
                </div>
              </div>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4">
              ...
              <div class="w-full sm:w-56">
                <n-select v-model:value="selectedVehicleType" :options="vehicleTypeOptions" clearable placeholder="全部车型" />
              </div>
            </div>
          </div>
                ...
                <div class="flex items-start justify-between mb-4">
                  <div class="flex-1">
                    ...
                    <div class="flex items-center gap-2 text-sm text-slate-500">
                      ...
                      <span>{{ space.SubDistrict_tc || space.SubDistrict }} - {{ space.District_tc || space.District }}</span>
                    </div>
                  </div>
