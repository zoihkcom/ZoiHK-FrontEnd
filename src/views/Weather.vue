    ...
    <div class="pt-20 px-4 sm:px-6 lg:px-8 pb-20">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="text-center space-y-3 mb-12">
          <p class="text-sm font-medium text-blue-600 uppercase tracking-[0.3em]">Hong Kong Weather</p>
          <h1 class="text-4xl sm:text-5xl font-bold text-slate-900">香港天气</h1>
          <p class="text-base sm:text-lg text-slate-600">实时天气信息与数据分析</p>
