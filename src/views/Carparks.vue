    ...
    <div class="pt-20 px-4 sm:px-6 lg:px-8 pb-20">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="text-center space-y-3 mb-8">
          <p class="text-sm font-medium text-blue-600 uppercase tracking-[0.3em]">Hong Kong Carparks</p>
          <h1 class="text-4xl sm:text-5xl font-bold text-slate-900">香港停车场信息</h1>
          <p class="text-base sm:text-lg text-slate-600">来自政府开放数据的停车场位置与车位信息</p>
        </div>
